...
function App() {
  ...
  return (
    <div>
      ...
      <Routes>
        <Route>
          <Route path='/dashboard' element={<Desktop150 setGin={setGin} setGrn={setGrn} setTransferNote={setTransferNote} setStockStatement={setStockStatement} setAgewiseANofStock={setAgewiseANofStock}></Desktop150>}>
          <Route index element={<Inventory setGin={[gin, setGin]} setGrn={[grn, setGrn]} setTransferNote={[transferNote, setTransferNote]} setStockStatement={[stockStatement, setStockStatement]} setAgewiseANofStock={[AgewiseANofStock, setAgewiseANofStock]}></Inventory>}></Route>
