...
const ProjectWiseReportTransferNote = ({setprojectWiseReportStockStatement, setEditTransferNote, setRegister, setIndividulProject, setAllProject}) => {
    const handleGetBack = () => {
                ...
                <div class="card flex box-shadow justify-center box-shadow shadow-2xl bg-white">
                    <div class="card-body">
                        <div className='flex items-center'>
                            ...
                            <h2 class="card-title">Project Wise Report Stock Statement</h2>
                        </div>
...
export default ProjectWiseReportTransferNote;