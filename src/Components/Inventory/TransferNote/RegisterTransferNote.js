...
import AllRegisteredTransferedNote from './AllRegisteredTransferedNote';

const RegisterTransferNote = ({setCreate,setEditGRN,setRegister}) => {
    ...
    const handleCreate = () =>{
        setRegisterNote('setRegisterNote'); 
    }
    return (
        <div className='w-100'>
            <div className='mx-16 mt-8 '>
                    ...
                    <div class="card flex box-shadow justify-center box-shadow shadow-2xl bg-white">
                        <div class="card-body">
                            <div className='flex items-center'>
                                ...
                                <h2 class="card-title">Register Transfer</h2>
                            </div>      
                ...
                <button onClick={handleCreate} style={{backgroundColor: '#7E76CA', width:'235px', marginTop: '60px', height: '50px', border: '0', borderRadius: '20px'}} class="create-button btn block text-white mx-auto ">Search</button>
                    ...
                    {
                        registerNote && <AllRegisteredTransferedNote setRegisterNote={setRegisterNote}></AllRegisteredTransferedNote>
                    }
                </div>
                }
                </div>
...
export default RegisterTransferNote;