...
import AllRegisteredGIN from './AllRegisteredGIN';

const Register = ({setCreate,setEditGRN,setRegister}) => {
    const [registeredGIN, setRegisteredGIN] = useState(''); 
    const handleGetBack = () =>{
        setCreate(''); 
        setEditGRN('');
        setRegister(''); 
    ...
    const handleCreate = () =>{
        setRegisteredGIN('setRegisteredGIN'); 
    }
    return (
        <div className='w-100'>
            <div className='mx-16 mt-8 '>
                {
                    ...
                    {
                        registeredGIN && <AllRegisteredGIN setRegisteredGIN={setRegisteredGIN}></AllRegisteredGIN>
                    }
                </div>
                }
            </div>
