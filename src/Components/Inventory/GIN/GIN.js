...
import CreateGIN from './CreateGIN';
import EditViewDelete from './EditViewDelete';
import Register from './Register';

const GIN = ({data, setGin, setGrn, setTransferNote, setStockStatement,setAgewiseANofStock}) => {
    ...
    return (
        <div>
            ...
            {
                create && <CreateGIN setCreate={setCreate} setEditGRN={setEditGRN} setRegister={setRegister}></CreateGIN>
            }
            {
                editGRN && <EditViewDelete setCreate={setCreate} setEditGRN={setEditGRN} setRegister={setRegister}></EditViewDelete>
            }
            {
