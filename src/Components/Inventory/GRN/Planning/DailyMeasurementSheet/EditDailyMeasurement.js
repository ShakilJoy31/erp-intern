...
const EditDailyMeasurement = ({ setCreate, setEdit, setRegister }) => {
    const handleGetBack = () =>{
        setCreate('')
        setEdit('')
        setRegister('')
                ...
                <div class="card flex justify-center shadow-2xl bg-white">
                    <div class="card-body">
                        <div className='flex items-center'>
                            ...
                            <h2 class="card-title">Edit/View/Delete Daily Measurement Sheet for Subcontractor</h2>
                        </div>
...
export default EditDailyMeasurement;