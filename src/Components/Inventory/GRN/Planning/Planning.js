...
const Planning = () => {
    ...
    return (
        <div className='inventory-card'>
            {
                (!dailyMeasurement && !PRPO && !prestart && !billing && !project && !liability) ? <div className='mx-16 mt-8 '>
                <div class="card bg-white box-shadow flex justify-center shadow-2xl">
                    <div class="card-body">
                        ...
                        <div onClick={projectMilestones} className='flex forHover'>
                            <p className='py-4'>Project Milestones</p>
                            <img src={rightArrow} alt="" />
                        </div>
                        <hr className='w-screen line'></hr>
                        <div onClick={liabilityStatement} className='flex forHover'>
                            <p className='py-4'>Liability Statement</p>
                            <img src={rightArrow} alt="" />
                        </div>
                        <hr className='w-screen line'></hr>
                        </div>
