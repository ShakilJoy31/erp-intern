...
import ListOfRegisteredProject from './ListOfRegisteredProject';


const RegisterProjectMilestone = ({ setRegister, setEditGRN, setCreate }) => {
        ...
        <div className='w-100'>
            <div className='mt-24 '>
                    ...
                    <div class="card flex justify-center box-shadow shadow-2xl bg-white">
                        <div class="card-body">
                            <div className='flex items-center'>
                                ...
                                <h2 class="card-title">Register Project Milestone</h2>
                            </div>
                ...
                <button onClick={handleCreate}  class="create-button btn block text-white mx-auto action-button">Create</button>
                        ...
                        {
                            register && <ListOfRegisteredProject setRegistered={setRegistered}></ListOfRegisteredProject>
                        }
                    </div>
                }
            </div>
