...
const EditProjectMilestone = ({ setRegister, setEditGRN, setCreate }) => {
                    ...
                    <div class="card flex box-shadow justify-center box-shadow shadow-2xl bg-white">
                        <div class="card-body">
                            <div className='flex items-center'>
                                ...
                                <h2 class="card-title">Edit/View/Delete Project Milestone</h2>
                            </div>
...
export default EditProjectMilestone;