...
const RegisterPRPO = ({ setRegister, setEditGRN, setCreate }) => {
        ...
        <div className='w-100'>
            <div className='mt-8 '>
                    ...
                    <div class="card flex box-shadow justify-center box-shadow shadow-2xl bg-white">
                        <div class="card-body">
                            <div className='flex items-center'>
                                ...
                                <h2 class="card-title">Register PRPO</h2>
                            </div>
                ...
                <button onClick={handleCreate}  class="create-button btn block text-white mx-auto action-button">Create</button>
                        ...
                        {
                            register && <RegisteredList setRegistered={setRegistered}></RegisteredList>
                        }
                    </div>
                }
            </div>
