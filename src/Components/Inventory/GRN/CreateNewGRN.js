...
import AllGRN from './AllGRN';

const CreateNewGRN = ({setCreate,setEditGRN,setRegister}) => {
    const [create, setCreateGRN] = useState('');
    const handleGetBack = () =>{
        setCreate(''); 
        setEditGRN(''); 
        setRegister(''); 
    ...
    const handleCreate = () =>{
        setCreateGRN('setCreateGRN'); 
    }
    return (
        <div className='mx-16 mt-24 w-100'>
            {
                (!create) ? <div>
                <div className=''>
                    ...
                    <div class="card flex justify-center box-shadow shadow-2xl bg-white">
                        <div class="card-body">
                            <div className='flex items-center'>
                                ...
                                <h2 class="card-title">Create New GRN</h2>
                            </div>
                ...
                <button onClick={handleCreate} style={{backgroundColor: '#7E76CA', width:'235px', marginTop: '60px', height: '50px', border: '0', borderRadius: '20px'}} class="create-button btn block text-white mx-auto ">Create</button>
                    ...
                    {
                        create && <AllGRN setCreateGRN={setCreateGRN}></AllGRN>
                    }
                </div>
            }
        </div>
