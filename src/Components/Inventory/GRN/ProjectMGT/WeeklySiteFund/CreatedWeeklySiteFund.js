...
import CreateWeeklySiteFund from './CreateWeeklySiteFund';

const CreatedWeeklySiteFund = ({ setEdit, setCreate}) => {
        ...
        <div className='mx-16 mt-12'>
            {
                ...
                <div className='flex items-center mb-8'>
                    ...
                    {
                        curve && <CreateWeeklySiteFund setCurve={setCurve}></CreateWeeklySiteFund>
                    }
                </div>
            }
        </div>
...
export default CreatedWeeklySiteFund;