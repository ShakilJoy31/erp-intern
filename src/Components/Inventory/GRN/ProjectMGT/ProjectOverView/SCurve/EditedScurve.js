...
import EditScurve from './EditScurve';

const EditedScurve = ({setCreate, setEdit}) => {
        ...
        <div className='mx-16 mt-12'>
            {
                ...
                <div className='flex items-center ms-12'>
                    <h1 className='mb-10 text-3xl'>Create/Edit/Delete S-Surve</h1>
              ...
              {
                sCurve && <EditScurve setScurve={setScurve}></EditScurve>
              }
            </div>
            }
        </div>
