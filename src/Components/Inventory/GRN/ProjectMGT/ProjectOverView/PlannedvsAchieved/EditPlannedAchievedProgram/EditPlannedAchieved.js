...
const EditPlannedAchieved = ({setCurve}) => {
    const handleGetBack = () =>{
        setCurve(''); 
    }
    return ( 
                    ...
                    <div class="card flex justify-center shadow-2xl bg-white">
                        <div class="card-body">
                            <div className='flex items-center'>
                                ...
                                <h2 class="card-title">Edit Planned Achieved</h2>
                            </div>
                            ...
                            <div>
                                <div>
                                    ...
                                    <div className='flex'>
                                    <div class="form-control w-64 mr-12 max-w-lg">
                                        <label class="label">
                                            <span class="label-text">From</span>
...
export default EditPlannedAchieved;