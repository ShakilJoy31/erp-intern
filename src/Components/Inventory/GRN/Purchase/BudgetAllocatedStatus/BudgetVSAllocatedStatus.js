...
const BudgetVSAllocatedStatus = ({data, setPurchaseRequisitionStatus, setCreateOrder, setOrderAmendment, setOrderStatus, setRequisitionOrderLeadTimeAnalysis, setRequestforQuotation, setVendorRegister, setComparativeStatement, setPBGProformaInvoiceDetails, setBudgetVSAllocatedStatus, setPDCAndLCdetails}) => {
        ...
        <div>
        {
            ...
            <div class="card flex justify-center shadow-2xl bg-white">
                <div class="card-body">
                    ...
                    <h2 class="card-title">Budget VS Allocated Status</h2>
                </div>
                    </div>
                    {
...
export default BudgetVSAllocatedStatus;