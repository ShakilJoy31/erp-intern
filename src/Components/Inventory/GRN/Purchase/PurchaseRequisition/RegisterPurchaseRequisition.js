...
const RegisterPurchaseRequisition = ({ setCreate, setEditGRN, setRegister}) => {
    const handleGetBack = () =>{
        setCreate('')
        setEditGRN('')
        setRegister('')
                ...
                <div class="card flex justify-center shadow-2xl bg-white">
                    <div class="card-body">
                        <div className='flex items-center'>
                            ...
                            <h2 class="card-title">Register Purchase Requisition</h2>
                        </div>
...
export default RegisterPurchaseRequisition;