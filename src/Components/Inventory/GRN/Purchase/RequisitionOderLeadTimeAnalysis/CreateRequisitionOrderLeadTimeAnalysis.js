...
const CreateRequisitionOrderLeadTimeAnalysis = ({ setCreate, setEditGRN, setRegister}) => {
    const handleGetBack = () =>{
        setCreate('')
        setEditGRN('')
        setRegister('') 
                ...
                <div class="card flex justify-center shadow-2xl bg-white">
                    <div class="card-body">
                        <div className='flex items-center'>
                            ...
                            <h2 class="card-title">Create Requisition Order Lead Time Analysis</h2>
                        </div>
...
export default CreateRequisitionOrderLeadTimeAnalysis;