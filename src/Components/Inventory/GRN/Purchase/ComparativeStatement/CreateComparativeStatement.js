...
const CreateComparativeStatement = ({ setCreate, setEditGRN, setRegister}) => {
    const handleGetBack = () =>{
        setCreate('')
        setEditGRN('')
        setRegister('') 
                ...
                <div class="card flex box-shadow justify-center box-shadow shadow-2xl bg-white">
                    <div class="card-body">
                        <div className='flex items-center'>
                            ...
                            <h2 class="card-title">Create Comparative Statement</h2>
                        </div>
...
export default CreateComparativeStatement;