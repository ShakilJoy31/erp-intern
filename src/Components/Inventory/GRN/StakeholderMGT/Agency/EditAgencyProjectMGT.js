...
import EditedAgencyList from './EditedAgencyList';

const EditAgencyProjectMGT = ( { setRegister, setEdit, setCreate }) => {
        ...
        <div className='w-100'>
            <div className='mx-16 mt-24 '>
                ...
                <button onClick={handleCreate} class="create-button btn block text-white mx-auto action-button">Register</button>
                        ...
                        {
                            list && <EditedAgencyList setList={setList}></EditedAgencyList>
                        }
                    </div>
                }
            </div>
...
export default EditAgencyProjectMGT;