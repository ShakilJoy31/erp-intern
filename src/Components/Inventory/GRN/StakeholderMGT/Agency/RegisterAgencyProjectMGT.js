...
import RegisteredAgencyList from './RegisteredAgencyList';

const RegisterAgencyProjectMGT = ( { setRegister, setEdit, setCreate}) => {
        ...
        <div className='w-100'>
            <div className='mx-16 mt-24 '>
                 ...
                 <div class="card flex justify-center box-shadow shadow-2xl bg-white">
                     <div class="card-body">
                         <div className='flex items-center'>
                             ...
                             <h2 class="card-title">Register Agency</h2>
                         </div>
             ...
             <button onClick={handleCreate} class="create-button btn block text-white mx-auto action-button">Create</button>
                    ...
                    {
                        list && <RegisteredAgencyList setList={setList}></RegisteredAgencyList>
                    }
                </div>
               }
            </div>
...
export default RegisterAgencyProjectMGT;