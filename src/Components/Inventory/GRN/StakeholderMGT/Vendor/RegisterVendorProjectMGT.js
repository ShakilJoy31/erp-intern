...
import RegisteredVendorList from './RegisteredVendorList';

const RegisterVendorProjectMGT = ( { setRegister, setEdit, setCreate}) => {
        ...
        <div className='w-100'>
            <div className='mx-16 mt-24 '>
                    ...
                    <div class="card flex justify-center box-shadow shadow-2xl bg-white">
                        <div class="card-body">
                            <div className='flex items-center'>
                                ...
                                <h2 class="card-title">Register Vendor</h2>
                            </div>
                ...
                <button onClick={handleCreate} class="create-button btn block text-white mx-auto action-button">Create</button>
                        ...
                        {
                            list && <RegisteredVendorList setList={setList}></RegisteredVendorList>
                        }
                    </div>
                }
            </div>
...
export default RegisterVendorProjectMGT;